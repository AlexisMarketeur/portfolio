...
export default function Method() {
  ...
  return (
    <section id="methode" className="flex w-full justify-center ">
      <div
        className="w-12/12 flex flex-col rounded-lg border-2 border-b-4 border-black md:w-9/12
      "
      >
        <div className="p-8 lg:p-12">
          ...
          <div className="mt-14 flex w-full flex-col items-center  lg:mt-20 lg:flex-row lg:gap-24">
            ...
            <article className="my-14 flex h-auto min-h-60  w-full flex-col items-center justify-start rounded-lg border-black lg:my-0 lg:min-h-96 lg:justify-center lg:border-2 lg:border-b-4 lg:p-8">
